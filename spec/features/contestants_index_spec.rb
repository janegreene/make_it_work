...
RSpec.describe "contestants index page " do
  it "list of names of all the contestants under each contestants name I see a list of the projects (names) that they've been on" do
    ...
    within(".contestant-#{kentaro.id}") do
      ...
      #currently not putting both project on same line. need help method perhaps
    end
